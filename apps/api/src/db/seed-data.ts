...
// Contenido inicial. Después se edita desde /admin, no aquí.
// TODO(Jonathan): revisar textos, enlaces e imágenes de "adopcion" y "pagina-web".
export const seedProjects: NewProject[] = [
  {
    slug: 'sistema-adopcion',
    position: 1,
    featured: true,
    titleEs: 'Sistema de adopción',
    titleEn: 'Adoption system',
    summaryEs:
      'Plataforma para publicar animales en adopción, recibir solicitudes y darles seguimiento hasta que encuentran hogar.',
    summaryEn:
  ...
  },
  {
    ...
    detailsEs:
      'Busca negocios con Google Places, puntúa cada uno según señales de encaje y usa Claude para escribir el primer contacto. Tiene panel web para revisar y aprobar cada borrador.',
    detailsEn:
  ...
  },
  {
    ...
    titleEs: 'Página web',
    titleEn: 'Website',
    summaryEs: 'Sitio web responsive, pensado para cargar rápido y verse bien en el celular.',
